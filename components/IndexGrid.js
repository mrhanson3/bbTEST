    ...
    <div className={classes.root}>
      <Grid container spacing={3}>
        <Grid item xs={12} sm={4}>
          <Paper className={classes.paper} elevation={3}>Updated 12/14/20<GamblingCard>
          </GamblingCard>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Paper className={classes.paper} elevation={3}>Updated 12/12/20<CovidCard>
          </CovidCard>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Paper className={classes.paper} elevation={3}>Posted 12/10/20<CompassRose>
          </CompassRose></Paper>
        </Grid>
        ...
        <Grid item xs={12} sm={4}>
          <Paper className={classes.paper} elevation={3}>Posted 11/20/20<GamblingCard19>
